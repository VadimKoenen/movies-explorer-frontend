...
и дочь. Я люблю слушать музыку, а ещё увлекаюсь бегом. Недавно начал кодить. С 2015 года работал в компании «СКБ Контур». После того, как прошёл курс по веб-разработке, начал заниматься фриланс-заказами и ушёл с постоянной работы.
          ...
          <a className="about-me__git" target="_blank" rel="noreferrer" href="https://github.com/VadimKoenen">GitHub</a>
        </div>
      ...
      <ul className="about-me__list">
        ...
        <li className="about-me__site">
          <a href="https://VadimKoenen.github.io/mesto/" className="about-me__link" target="_blank" rel="noreferrer">
            <p className="about-me__another-site about-me__another-site_title">
